...
define('PXE_IMAGE_DNSADDRESS',  '10.10.8.1');
define('STORAGE_HOST', '10.10.8.54');
...
define('WEB_HOST', '10.10.8.54');
define('WEB_ROOT', '/fog/');
define('WOL_HOST', '10.10.8.54'); 	
...
define('MYSQL_PASSWORD', 'TG9wY7svpvdseVpn');
